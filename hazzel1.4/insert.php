...
<input type="hidden" value="8" name="num_co" />
...
<form action="database.php" method="post">
<input type="hidden" value="5" name="num_co" />
...
<form action="database.php" method="post">
<input type="hidden" value="3" name="num_co" />
...
<form action="database.php" method="post">
<input type="hidden" value="6" name="num_co" />
...
<form action="database.php" method="post">
<input type="hidden" value="4" name="num_co" />
...
<form action="database.php" method="post">
<input type="hidden" value="7" name="num_co" />
